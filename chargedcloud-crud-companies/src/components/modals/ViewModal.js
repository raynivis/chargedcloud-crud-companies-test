                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h6 className="modal-title d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#38AFF1" className="mr-2">
                        ...
                        <div className="modal-body">
                            <div className="container">
                                ...
                                <p className="d-flex align-items-center mb-2">
                                    ...
                                    <strong>Subscription Plan: </strong> {company.plan}
                                </p>
                                <p className="d-flex align-items-center mb-2">
