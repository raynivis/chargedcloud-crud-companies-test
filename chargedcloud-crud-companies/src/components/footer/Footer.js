            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-8 col-sm-6 col-xs-12">
                        {/*Direitos mais detalhados no Rep do Git!*/}
                        <p className="copyright-text">Copyright &copy; 2025 All Rights Reserved by
                            <a href="https://chargedcloud.com.br/" className="link-light link-offset-2 link-underline link-underline-opacity-0" target="_blank"> Chargedcloud</a>.
                        </p>
                    </div>
                    {/*Divisao da redes sociais */}
                    <div className="col-md-4 col-sm-6 col-xs-12">
                        <ul className="social-icons">
                            <li>
                                <a className="email" href="mailto:contato@chargedcloud.com.br" target="_blank">
                            ...
                            <li>
                                <a className="whatsapp" href="https://wa.me/5516991672547" target="_blank">
                            ...
                            <li>
                                <a className="linkedin" href="https://www.linkedin.com/company/chargedcloud/" target="_blank">
