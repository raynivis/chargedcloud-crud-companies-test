...
function Form() {
    ...
    useEffect(() => {
        ...
        const handleSubmit = (event) => {
            ...
            //Valor e o proprio elemento do Campo CNPJ
            ...
            if (CheckCNPJ.validarCNPJ(cnpjInputValue)) {
                ...
                // Focar no elemento do input
                cnpjInput.focus();
                //Ir para o topo da tela
                window.scrollTo({ top: 0, behavior: "smooth" });
            }
        };
        //Evitando possiveis erros no console
        if(form) {
    ...
    return (
        <form className="form-horizontal" action=" " method="" id="companyForm">
            ...
            <fieldset className="d-flex row justify-content-center">
                ...
                <div className="container">
                    ...
                    <div className="input-group flex-nowrap">
                        ...
                        <input required type="text" className="form-control" placeholder="Corporation Name" aria-label="Corporation Name" aria-describedby="addon-wrapping" />
                    </div>
                    ...
                    <div className="input-group flex-nowrap">
                        ...
                        <input onKeyUp={handleCNPJKeyUp} maxlength="18" id="CNPJInput" required type="text" className="form-control" placeholder="00.000.000/0000-00" aria-label="CNPJ" aria-describedby="addon-wrapping" />
                    </div>
                    ...
                    <div className="input-group mb-3">
                        ...
                        <select className="form-select" id="inputGroupSelectPlan">
                    ...
                    <div className="input-group flex-nowrap">
                        ...
                        <input required type="tel" className="form-control" placeholder="+55000000000" aria-label="phone" aria-describedby="addon-wrapping" />
                    </div>
                    ...
                    <div className="input-group flex-nowrap">
                        ...
                        <input type="email" className="form-control" placeholder="company@domain.com" aria-label="email" aria-describedby="addon-wrapping" />
                    </div>
                    ...
                    <div className="input-group">
                        ...
                        <textarea required className="form-control" placeholder="Street, Number, Neighborhood, City/State" aria-label="address"></textarea>
                    </div>
                </div>
            </fieldset>
