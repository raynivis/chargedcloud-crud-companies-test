//Componente de registro do software
import "./Register.css";
                ...
                <fieldset className="d-flex row justify-content-center">
                    ...
                    <div className="container">
                        ...
                        <div className="input-group flex-nowrap">
                            ...
                            <input required type="text" className="form-control" placeholder="00.000.000/0000-00" aria-label="CNPJ" aria-describedby="addon-wrapping" />
                        </div>
